...
def _new_project(project_dir: str) -> None:
    ...
    print(
        f"New empty PORT-EK project created in {project_dir}. Please edit config.yaml and generte_kmers.sh files as required and copy input fasta files into {project_dir}/input."
    )
